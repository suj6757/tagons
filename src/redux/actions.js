...
/* TREND INDUSTRY */
export const TREND_INDUSTRY_EFACTOR_GI = 'TREND_INDUSTRY_EFACTOR_GI';
export const TREND_INDUSTRY_EFACTOR_GI_RELATEDWORDS = 'TREND_INDUSTRY_EFACTOR_GI_RELATEDWORDS';
export const TREND_INDUSTRY_EFACTOR_TRENDANDFACTOR = 'TREND_INDUSTRY_EFACTOR_TRENDANDFACTOR';
export const TREND_INDUSTRY_EFACTOR_TRENDQUAD = 'TREND_INDUSTRY_EFACTOR_TRENDQUAD';
export const TREND_INDUSTRY_PFACTOR_GI = 'TREND_INDUSTRY_PFACTOR_GI';
export const TREND_INDUSTRY_PFACTOR_GI_RELATEDWORDS = 'TREND_INDUSTRY_PFACTOR_GI_RELATEDWORDS';
export const TREND_INDUSTRY_PFACTOR_TRENDANDFACTOR = 'TREND_INDUSTRY_PFACTOR_TRENDANDFACTOR';
export const TREND_INDUSTRY_PFACTOR_TRENDQUAD = 'TREND_INDUSTRY_PFACTOR_TRENDQUAD';
...
export const TREND_SUCCESS_INDUSTRY_TOTALCATEGORY_LIST = 'TREND_SUCCESS_INDUSTRY_TOTALCATEGORY_LIST';
export const TREND_INDUSTRY_GI_BUBBLE = 'TREND_INDUSTRY_GI_BUBBLE';
