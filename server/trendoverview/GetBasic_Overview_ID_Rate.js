...
router.use('/', (req, res) => {
    ...
    if( methodType == 'GET' ){
      ...
      data2.Selected_Channel = parseObj.query.Selected_Channel;
      ...
      data2.Selected_Channel = req.body.Selected_Channel;
      data2.Company = req.body.Company;
      data2.CompanyCode = req.body.CompanyCode;
    }
    console.log(data2);
    client.GetBasic_Overview_ID_Rate(data2, function(err, data) {
        try {
