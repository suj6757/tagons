...
router.use('/', (req, res) => {
    ...
    var PROTO_PATH_TEST = path.join(__dirname,'../proto/TrendOverviewService.proto') ;
    ...
    var client = new protoDescriptor.TrendOverviewService.TrendOverviewInfo(serverIpNew, grpcjs.credentials.createInsecure());
    ...
    if( methodType == 'GET' ){
      ...
      data2.Selected_Tab = parseObj.query.Selected_Tab;
      data2.Company = parseObj.query.Company;
      data2.CompanyCode = parseObj.query.CompanyCode;
      data2.Channel1 = parseObj.query.Channel1;
      data2.Channel2 = parseObj.query.Channel2;
    }
    else{
      ...
      data2.Selected_Tab = req.body.Selected_Tab;
      data2.Company = req.body.Company;
      data2.CompanyCode = req.body.CompanyCode;
      data2.Channel1 = req.body.Channel1;
      data2.Channel2 = req.body.Channel2;
    }
    console.log(data2);
    client.GetBasic_Overview_Gap2(data2, function(err, data) {
        try {
