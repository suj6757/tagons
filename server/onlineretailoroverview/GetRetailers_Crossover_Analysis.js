...
router.use('/', (req, res) => {
  ...
  var client = new protoDescriptor.OnDetailOverviewService.GetRetailers_Crossover_Analysis(serverIpNew, grpcjs.credentials.createInsecure());
  ...
  console.log(data2);
  client.GetRetailers_Crossover_Analysis(data2, function(err, data) {
    try {
