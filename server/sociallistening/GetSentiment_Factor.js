...
router.use('/', (req, res) => {
    ...
    var client = new protoDescriptor.SocialListeningService.SocialListeningInfo(serverIpNew, grpcjs.credentials.createInsecure());
    ...
    if( methodType == 'GET' ){
      ...
      data2.Selected_Competitors = parseObj.query.Selected_Competitors;
      ...
      data2.Selected_Competitors = req.body.Selected_Competitors;
      data2.Keyword = req.body.Keyword;
    }
    console.log(data2);
    client.GetSentiment_Factor(data2, function(err, data) {
        try {
