...
router.use('/', (req, res) => {
    console.log('/api/GetIndustry_EFactor_GI');
    ...
    if( methodType == 'GET' ){
      ...
      data2.Clicked = parseObj.query.Clicked;
    }
    else{
      ...
      data2.Clicked = req.body.Clicked;
    }
    client.GetIndustry_EFactor_GI(data2, function(err, data) {
        try {
