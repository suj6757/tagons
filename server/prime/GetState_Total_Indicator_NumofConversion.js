...
router.use('/', (req, res) => {
    ...
    var PROTO_PATH_TEST = path.join(__dirname,'../proto/PrimeService.proto') ;
    ...
    var client = new protoDescriptor.PrimeService.PrimeInfo(serverIpNew, grpcjs.credentials.createInsecure());
    ...
    console.log(data2);
    client.GetState_Total_Indicator_NumofConversion(data2, function(err, data) {
        try {
