...
router.use('/', (req, res) => {
    ...
    var PROTO_PATH_TEST = path.join(__dirname,'../proto/OnDetailPPIndicatorService.proto') ;
    ...
    var client = new protoDescriptor.OnDetailPPIndicatorService.OnDetailPPIndicatorInfo(serverIpNew, grpcjs.credentials.createInsecure());
    ...
    if( methodType == 'GET' ){
      ...
      data2.Brand = parseObj.query.Brand;
    }
    else{
      ...
      data2.Brand = req.body.Brand;
    }
    console.log(data2);
    client.GetBrand_ProductRank(data2, function(err, data) {
        try {
